...
public class UpdateHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        when(athenaClient.updatePreparedStatement(any(UpdatePreparedStatementRequest.class)))
            .thenReturn(UpdatePreparedStatementResponse.builder().build());
